 ...
 * @author usER
 */
public class PilihPemeriksaan extends java.awt.Dialog {
    ...
    private void tampilData1() {
        ...
        try {
            ...
            while(rst.next()) {
                ...
                tabemodel1.addRow(new String[]{idKaryawan, nama});
            }
            pst.close();
            rst.close();
        } catch(Exception ex) {
    ...
    private void tampilData2() {
        ...
        try {
            ...
            while(rst.next()) {
                ...
                tabemodel2.addRow(new Object[]{kode, nama, biaya});
            }
        } catch(Exception ex) {
            ex.printStackTrace();
        }
...
//  Pilih Karyawan
    private void pilihKaryawan() {
        ...
        if(selectRow != -1) {
        String idKaryawan = (String) table1.getValueAt(selectRow, 0);
...
//  Pilih Tindakan
    private void pilihTindakan() {
        int selectRow = table2.getSelectedRow();
        if(selectRow != -1) {
            String kode = (String) table2.getValueAt(selectRow, 0);
            String nama = (String) table2.getValueAt(selectRow, 1);
            int biaya = (int) table2.getValueAt(selectRow, 2);
            
            modelTindakan.setKodeTindakan(kode);
            modelTindakan.setNamaTindakan(nama);
...
//    Cari tindakan
    ...
    private void initComponents() {
        ...
        table2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kode Tindakan", "Nama Tindakan", "Biaya"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PilihPemeriksaan dialog = new PilihPemeriksaan(new java.awt.Frame(), true, "");
